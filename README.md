### Code Institiute - CSS Transitions - Transition Timing Function
...
***
#### project url: **'https://codeinstitute-davidhubber.github.io/ci-css_transitions-transition_timing_function/'**
***
title: **'Code Institiute - CSS Transitions - Transition Timing Function'**

description: **Transition Timing Function - A CSS property that sets the speed curve from of the transition effect by setting a value to the transition-timing-function. (i.e. linear, ease, ease-in, ease-out, ease-in-out etc).**
